...
public class RejectCaseHandler : IRejectCaseHandler
{
    private readonly IFinanceCaseRepository _repo;

    public RejectCaseHandler(IFinanceCaseRepository repo) => _repo = repo;

    public async Task<CaseDto> Handle(RejectCaseRequest request, CancellationToken ct)
    {
